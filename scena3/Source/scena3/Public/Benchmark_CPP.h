...
#include "Timer.h"
#include "Benchmark_CPP.generated.h"

// Event dispatcher do powiadomienia BP o zakoñczeniu benchmarku
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnBenchmarkComplete, float, AvgTimeMs);

UCLASS()
class SCENA3_API ABenchmark_CPP : public AActor
{
	GENERATED_BODY()
